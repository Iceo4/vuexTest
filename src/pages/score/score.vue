<template>
  	<div>
    	<div class="your_scores_container">
            <header class="your_scores"><span>50</span>分！</header>
            <div class="result_tip">智地方舒服力来凑！</div>
        </div>
        <div class="share_button" @click="showCover"></div>
        <div class="share_code">
            <header class="share_header">关注葡萄之家,获取答案。</header>
            <img src="../../imgs/4-4.png" height="212" width="212" class="code_img"> 
        </div>
        <div class="share_cover" v-show="showHide" @click="showCover">
            <img src="../../imgs/5-2.png" class="share_img">
        </div>
  	</div>
</template>
...
<style lang="less">
    ...
    .share_button{
        ...
        background: url(../../imgs/4-3.png) no-repeat 0.4rem 0;
